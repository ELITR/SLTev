#! /bin/bash
# we suppose that $1 is OStt and $2 is tt $3 is mt and $4 is parallel_source and $5 is  parallel_target $6 is output path 
...
#-------- run sltev 
python SLTev.py --ostt $1 --tt $2 --mt $3 --align ref_alignment --b_time 300 > $6